				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item[3.a] korisnik promijeni korisničko ime upisivanjem novog imena
							\item[3.b] korisnik promijeni lozinku upisivanjem nove lozinke 
							\item klikom na gumb "Pohrani promjene" se u bazu podataka upisuju promjene
						\end{packed_enum}
						
						\item  \textbf{Opis mogućih odstupanja:}
						\item[] \begin{packed_item}
							\item[3.c] novo korisničko ime je zauzeto
							\begin{packed_enum}
								\item prikacuje se poruka "Korisničko ime zauzeto!"
							\end{packed_enum}
							\item[3.d] lozinka je slaba (sadrži manje od 6 znakova i/ili sadrži samo slova)
							\begin{packed_enum}
								\item prikazuje se poruka "Lozinka mora imati najmanje 6 znakova te barem jedan broj ili specijalan znak!"
							\end{packed_enum}
						\end{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - prijava na recepte korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 - pregled obavijesti}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: korisnik}
					...
					\noindent \underbar{\textbf{UC9 - spremanje/bookmarkanje recepta}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: korisnik}
						...
						\item  \textbf{Opis osnovnog tijeka:}
						\item[] \begin{packed_enum}
							\item[9.a] korisnik klikne na gumb za spremanje recepta iz liste recepata
							\item[9.b] korisnik klikne na gumb za spremanje recepata prilikom prikaza pojedinog recepta
							\item recept se sprema pod omiljene recepte
						\end{packed_enum}
						
						\item  \textbf{Opis mogućih odstupanja:}
						\item[] \begin{packed_item}
							\item[9.c] recept je već spremljen kao omiljen
							\begin{packed_enum}
