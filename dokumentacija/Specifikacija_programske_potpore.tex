	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC06 - pregled liste recepata}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: korisnik}
					...
					\noindent \underbar{\textbf{UC07 - stvaranje novog recepta}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: korisnik}
					...
					\noindent \underbar{\textbf{UC08 - prijava na recepte korisnika}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC09 - pregled obavijesti}}
					\begin{packed_item}
						\item \textbf{Glavni sudionik: korisnik}
